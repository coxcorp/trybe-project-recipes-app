...
describe('Testando a página principal de Receitas', () => {
  ...
  beforeEach(() => {
    renderWithRouter(<Provider><FavoritesRecipes /></Provider>);
  });
  ...
  test('testa se renderiza os elementos na tela', async () => {
    ...
    const removeFav0 = screen.getByTestId('0-horizontal-favorite-btn');
    const removeFav1 = screen.getByTestId('1-horizontal-favorite-btn');
    ...
    expect(removeFav0).toBeInTheDocument();
    expect(removeFav1).toBeInTheDocument();
